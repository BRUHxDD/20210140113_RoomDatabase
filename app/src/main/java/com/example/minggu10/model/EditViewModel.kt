package com.example.minggu10.model
...
import com.example.minggu10.repositori.RepositoriSiswa
...
class EditViewModel(
    ...
    init {
        viewModelScope.launch {
            siswaUiState =
                repositoriSiswa.getSiswaStream(itemId).filterNotNull().first().toUiStateSiswa(true)
        }
    }
